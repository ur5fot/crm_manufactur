...
- [x] запустити повний `npm run test:e2e` — всі 118 тестів проходять
- [x] перевірити що немає інших місць де `status-history-modal` використовується для репрімандів
