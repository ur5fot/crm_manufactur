...
- [x] Двойной клик на любую ячейку строки НЕ открывает inline-редактирование
- [x] Двойной клик на ID НЕ навигирует на карточку в текущем окне
- [x] Двойной клик на строку открывает карточку в новой вкладке/окне
- [x] Файл `useTableInlineEdit.js` удалён
- [x] Нет сломанных тестов
