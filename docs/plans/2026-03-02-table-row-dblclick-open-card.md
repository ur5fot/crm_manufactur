...
- [ ] Проверить другие E2E тесты на упоминания inline edit в таблице
- [ ] Добавить E2E тест: двойной клик по строке таблицы открывает карточку в новой вкладке
- [ ] Запустить все E2E тесты — должны пройти

### Task 3: Обновить документацию
- [ ] Обновить CLAUDE.md: убрать упоминания `useTableInlineEdit.js` из структуры проекта и описаний
- [ ] Обновить CLAUDE.md: обновить описание TableView (двойной клик → новая вкладка вместо inline edit)
