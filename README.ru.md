...
- **Сводная таблица** - 9 колонок с inline редактированием и множественными фильтрами
...
│   ├── logs.csv                   # Журнал аудита всех изменений
│   └── dictionaries.csv           # (устаревший, для совместимости)
├── files/
