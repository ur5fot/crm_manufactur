          ...
          - generic [ref=e446]:
            ...
            - table [ref=e450]:
              ...
              - rowgroup [ref=e458]:
                ...
                - row "Водійське посвідчення ✓ Завантажено 01.06.2022 01.06.2032 Відкрити Замінити Дати Видалити" [ref=e483]:
                  - cell "Водійське посвідчення" [ref=e484]
                  - cell "✓ Завантажено" [ref=e485]
                  - cell "01.06.2022" [ref=e486]
                  - cell "01.06.2032" [ref=e487]
                  - cell "Відкрити Замінити Дати Видалити" [ref=e488]:
                    - generic [ref=e489]:
                      - button "Відкрити" [ref=e490] [cursor=pointer]
                      - button "Замінити" [ref=e491] [cursor=pointer]
                      - button "Дати" [ref=e492] [cursor=pointer]
                      - button "Видалити" [ref=e493] [cursor=pointer]
                - row "Посвідчення особи ✗ Не завантажено — — Завантажити" [ref=e494]:
                  - cell "Посвідчення особи" [ref=e495]
                  - cell "✗ Не завантажено" [ref=e496]
                  - cell "—" [ref=e497]
                  - cell "—" [ref=e498]
                  - cell "Завантажити" [ref=e499]:
                    - button "Завантажити" [ref=e501] [cursor=pointer]
                - row "Закордонний паспорт ✗ Не завантажено — — Завантажити" [ref=e502]:
                  - cell "Закордонний паспорт" [ref=e503]
                  - cell "✗ Не завантажено" [ref=e504]
                  - cell "—" [ref=e505]
                  - cell "—" [ref=e506]
                  - cell "Завантажити" [ref=e507]:
                    - button "Завантажити" [ref=e509] [cursor=pointer]
                - row "Довідка про несудимість ✗ Не завантажено — — Завантажити" [ref=e510]:
                  - cell "Довідка про несудимість" [ref=e511]
                  - cell "✗ Не завантажено" [ref=e512]
                  - cell "—" [ref=e513]
                  - cell "—" [ref=e514]
                  - cell "Завантажити" [ref=e515]:
                    - button "Завантажити" [ref=e517] [cursor=pointer]
                - row "Військовий квиток ✗ Не завантажено — — Завантажити" [ref=e518]:
                  - cell "Військовий квиток" [ref=e519]
                  - cell "✗ Не завантажено" [ref=e520]
                  - cell "—" [ref=e521]
                  - cell "—" [ref=e522]
                  - cell "Завантажити" [ref=e523]:
                    - button "Завантажити" [ref=e525] [cursor=pointer]
                - row "Медична довідка ✗ Не завантажено — — Завантажити" [ref=e526]:
                  - cell "Медична довідка" [ref=e527]
                  - cell "✗ Не завантажено" [ref=e528]
                  - cell "—" [ref=e529]
                  - cell "—" [ref=e530]
                  - cell "Завантажити" [ref=e531]:
                    - button "Завантажити" [ref=e533] [cursor=pointer]
                - row "Страховий поліс ✗ Не завантажено — — Завантажити" [ref=e534]:
                  - cell "Страховий поліс" [ref=e535]
                  - cell "✗ Не завантажено" [ref=e536]
                  - cell "—" [ref=e537]
                  - cell "—" [ref=e538]
                  - cell "Завантажити" [ref=e539]:
                    - button "Завантажити" [ref=e541] [cursor=pointer]
                - row "Диплом про освіту ✗ Не завантажено — — Завантажити" [ref=e542]:
                  - cell "Диплом про освіту" [ref=e543]
                  - cell "✗ Не завантажено" [ref=e544]
                  - cell "—" [ref=e545]
                  - cell "—" [ref=e546]
                  - cell "Завантажити" [ref=e547]:
                    - button "Завантажити" [ref=e549] [cursor=pointer]
          - generic [ref=e551]:
            - generic [ref=e552]: CSV файли
            - button "Відкрити папку data" [ref=e553] [cursor=pointer]
```